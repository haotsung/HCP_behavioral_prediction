...
for fold_idx, (train_idx,test_idx) in enumerate(rgkf.split(X,y,groups=groups)): 
    ...
    grid_search.fit(X_train_scaled, y_train_aligned[component])
...
df_results.to_csv(f"/home/haotsung/HCP_behavioral_prediction/results/ica_results/scores_krr_{component}_align.csv")