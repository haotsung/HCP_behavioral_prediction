...
# %%
X = brain_columns + behavioral_columns
y = "__generated__"
...
ica = FastICA()
target_creator.add(ica,n_components=3,max_iter=10000000, tol=0.01,random_state=42)
...
rgkf = RepeatedGroupKFold(n_splits=10, n_repeats=5, random_state=42)
# %%
...
# %%
scores_tuned.to_csv(f"/home/haotsung/HCP_behavioral_prediction/results/ica_results/scores_krr_{component}.csv")