...
target_creator.add("pick_columns", keep=component, apply_to="continuous")
...
# %%
scores_tuned.to_csv(f"/home/haotsung/HCP_behavioral_prediction/results/scores_krr_{component}_test.csv")